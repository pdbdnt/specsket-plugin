...
9. Immediately before each chunk, refresh a receipt with less than 120 seconds remaining. Stage only the exact validated submission with its returned digest and receipt. Keep chunk indexes and idempotency keys stable across exact retries.
